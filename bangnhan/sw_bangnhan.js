...
*/
const BANGNHAN_CACHE = "bangnhan-separate-icon-20260612-01";
...
self.addEventListener("fetch", (event) => {
  ...
  // Only handle Bảng Nhân app folder. Do not control Chữ Cái or root apps.
  if (!url.pathname.includes("/bangnhan/")) return;
